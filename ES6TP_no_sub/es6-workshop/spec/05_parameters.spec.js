...
describe('Rest Parameters', () => {
  ...
  it('has a different length than `arguments`', () => {
    ...
    expect(resty(1,2).length).toBe(undefined);
    expect(resty(1,2,3).length).toBe(undefined);
    expect(resty(1,2,3, undefined, 5, undefined, 7, undefined, 9, 10).length).toBe(undefined);
  });
  ...
  describe('EXTRA CREDIT', ()=>{
    ...
    */
    ...
    it('it can default all arguments, optionally', () => {
      ...
      function myFunction({name=3, age=2, favoriteBand=2} = {}){
